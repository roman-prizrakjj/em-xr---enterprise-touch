    ...
    <section className="relative py-20 md:py-32 text-white overflow-hidden min-h-screen">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-8 md:mb-12">
          <div className="inline-flex items-center gap-2 bg-blue-600/20 text-blue-400 px-5 py-2 rounded-full text-sm font-medium mb-6 border border-blue-500/30 backdrop-blur-sm">
        ...
        <div className="text-center mb-6">
          <h3 className="text-2xl md:text-3xl font-bold text-white mb-2">{currentStandInfo.name}</h3>
          <p className="text-slate-400">{currentStandInfo.description}</p>
            ...
            {stands.map((stand) => (
              <button
                ...
                className={`w-2.5 h-2.5 rounded-full transition-all ${
                  currentStand === stand.id ? 'bg-blue-500 w-8' : 'bg-white/20 hover:bg-white/40'
                }`}
              />
            ))}
          </div>
        ...
        <div 
          ref={containerRef}
          className="relative flex justify-center items-end min-h-[800px] md:min-h-[950px]"
        ...
        >
          ...
          <button 
            onClick={prevStand}
            className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 z-20 w-14 h-14 md:w-16 md:h-16 bg-white/5 hover:bg-white/10 backdrop-blur-md border border-white/10 rounded-full flex items-center justify-center transition-all hover:scale-110 group"
          >
            <svg className="w-6 h-6 md:w-8 md:h-8 text-white/70 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button 
            onClick={nextStand}
            className="absolute right-4 md:right-8 top-1/2 -translate-y-1/2 z-20 w-14 h-14 md:w-16 md:h-16 bg-white/5 hover:bg-white/10 backdrop-blur-md border border-white/10 rounded-full flex items-center justify-center transition-all hover:scale-110 group"
          >
            <svg className="w-6 h-6 md:w-8 md:h-8 text-white/70 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Floor Reflection */}
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[200px] bg-gradient-to-t from-blue-600/10 to-transparent blur-3xl"></div>
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[400px] h-[100px] bg-gradient-to-t from-white/5 to-transparent blur-xl"></div>
          ...
          >
            ...
            <div className="relative animate-fadeIn" style={{ transformStyle: 'preserve-3d' }}>
              
              {/* Screen Housing - Top Part */}
              <div 
                className="relative bg-gradient-to-b from-zinc-700 via-zinc-800 to-zinc-900 rounded-[2.5rem] p-3 md:p-4"
                style={{ 
                  boxShadow: `
              ...
              >
                ...
                <div className="bg-black rounded-[2rem] p-2 relative">
                  {/* Glass Effect */}
                  <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-transparent rounded-[2rem] pointer-events-none z-10"></div>
                  
                  {/* Main Screen - Vertical Kiosk Aspect */}
                  <div className="relative w-[340px] md:w-[420px] h-[550px] md:h-[680px] bg-gradient-to-b from-slate-900 to-black rounded-[1.5rem] overflow-hidden">
                    
                    {/* Screen Content */}
                    <div className="absolute inset-0 flex flex-col">
                      
                      {/* Header Bar */}
                      <div className="bg-black/50 backdrop-blur-sm px-5 py-4 flex items-center justify-between border-b border-white/10">
                        {currentScreen !== 'home' ? (
                          <button 
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-white/80 text-base font-medium">EM XR Kiosk</span>
                          </div>
                        )}
                      ...
                      <div className="flex-1 relative overflow-hidden">
                        ...
                        {/* HOME SCREEN */}
                        {currentScreen === 'home' && (
                          <div className="absolute inset-0 p-5 md:p-6 animate-fadeIn">
                            <div className="bg-gradient-to-r from-blue-600 to-cyan-500 rounded-2xl p-6 mb-5 text-center">
                              <h3 className="text-2xl font-bold text-white mb-1">Добро пожаловать</h3>
                              <p className="text-white/80 text-base">Выберите раздел</p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                              {[
                                ...
                                <button 
                                  ...
                                  className="bg-white/5 hover:bg-white/10 backdrop-blur border border-white/10 rounded-2xl p-5 text-center transition-all hover:scale-105 active:scale-95 group"
                                >
                                  <div className={`w-14 h-14 mx-auto mb-3 rounded-xl bg-gradient-to-br ${item.color} flex items-center justify-center group-hover:shadow-lg transition-shadow`}>
                        ...
                        {currentScreen === 'metrics' && (
                          <div className="absolute inset-0 p-4 animate-fadeIn">
                            <div className="bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl p-4 mb-4 text-center">
                              <h3 className="text-lg font-bold text-white">Аналитика в реальном времени</h3>
                            </div>
                            
                            <div className="space-y-3">
                              {metrics.map((metric, idx) => (
                                <div key={idx} className="bg-white/5 backdrop-blur border border-white/10 rounded-xl p-3 flex items-center gap-3">
                            ...
                            <div className="mt-4 bg-white/5 rounded-xl p-3 border border-white/10">
                              <div className="text-white/60 text-xs mb-2">Активность за неделю</div>
                        ...
                        {currentScreen === 'presentation' && (
                          <div className="absolute inset-0 animate-fadeIn">
                            <div className={`h-full bg-gradient-to-br ${presentationSlides[presentationSlide].bg} flex flex-col items-center justify-center p-6 transition-all duration-500`}>
                              <div className="text-center">
                                <h3 className="text-2xl font-bold text-white mb-2">{presentationSlides[presentationSlide].title}</h3>
                                <p className="text-white/80">{presentationSlides[presentationSlide].subtitle}</p>
                              </div>
                                ...
                                {presentationSlides.map((_, idx) => (
                                  <button
                                    ...
                                    className={`w-2 h-2 rounded-full transition-all ${
                                      presentationSlide === idx ? 'bg-white w-6' : 'bg-white/40'
                                    }`}
                                  />
                                ))}
                              </div>
                        ...
                        {currentScreen === 'game' && (
                          <div className="absolute inset-0 p-4 animate-fadeIn">
                            <div className="bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl p-4 mb-4 text-center">
                              <h3 className="text-lg font-bold text-white">Поймай логотип!</h3>
                              <p className="text-white/80 text-sm">Счет: {gameScore}</p>
                            </div>
                            
                            <div className="relative bg-slate-800/50 rounded-xl h-[280px] border border-white/10 overflow-hidden">
                              {!gameActive ? (
                                <div className="absolute inset-0 flex flex-col items-center justify-center">
                                  ...
                                  <button 
                                    onClick={startGame}
                                    className="bg-gradient-to-r from-green-500 to-emerald-500 text-white font-bold py-3 px-6 rounded-xl hover:opacity-90 transition-opacity"
                                  >
                        ...
                        {currentScreen === 'catalog' && (
                          <div className="absolute inset-0 p-4 animate-fadeIn">
                            <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl p-4 mb-4 text-center">
                              <h3 className="text-lg font-bold text-white">Каталог продукции</h3>
                            </div>
                            
                            <div className="space-y-3">
                              {catalogItems.map((item, idx) => (
                                <button key={idx} className="w-full bg-white/5 backdrop-blur border border-white/10 rounded-xl p-4 text-left hover:bg-white/10 transition-all active:scale-98">
                                  <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex-1">
                                      ...
                                      <div className="text-blue-400 text-sm font-bold">{item.price}</div>
                                      <div className={`text-xs mt-1 ${item.status === 'В наличии' ? 'text-green-400' : 'text-yellow-400'}`}>
                                        {item.status}
                                      </div>
                                    </div>
                        ...
                        {currentScreen === 'contacts' && (
                          <div className="absolute inset-0 p-4 animate-fadeIn">
                            <div className="bg-gradient-to-r from-indigo-500 to-purple-500 rounded-2xl p-4 mb-4 text-center">
                            ...
                            <div className="space-y-3">
                              {[
                                ...
                                <div key={idx} className="bg-white/5 backdrop-blur border border-white/10 rounded-xl p-4">
                                  <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                      <div className="text-white/60 text-xs">{contact.label}</div>
                            ...
                            <button className="w-full mt-4 bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-bold py-3 rounded-xl hover:opacity-90 transition-opacity">
                              Оставить заявку
                            </button>
                          </div>
                        )}
              ...
              <div 
                className="mx-auto w-20 md:w-24 h-28 md:h-36 bg-gradient-to-b from-zinc-900 via-zinc-800 to-zinc-900 relative"
                style={{ 
              ...
              {/* Base Platform */}
              <div 
                className="mx-auto w-56 md:w-64 h-8 bg-gradient-to-b from-zinc-800 to-zinc-900 rounded-t-xl"
                style={{ 
              ...
              {/* Floor Base */}
              <div 
                className="mx-auto w-64 md:w-72 h-4 bg-gradient-to-b from-zinc-900 to-black rounded-xl"
                style={{ 
            ...
            <div className="relative animate-fadeIn flex flex-col items-center" style={{ transformStyle: 'preserve-3d' }}>
              {/* Table Top with Screen */}
              <div 
                className="relative bg-gradient-to-b from-zinc-700 via-zinc-800 to-zinc-900 rounded-[2.5rem] p-4"
                style={{ 
                  boxShadow: `
                    0 0 0 1px rgba(255,255,255,0.15),
                    0 50px 100px -20px rgba(0,0,0,0.9),
              ...
              >
                <div className="bg-black rounded-[2rem] p-2 relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-transparent rounded-[2rem] pointer-events-none z-10"></div>
                  <div className="relative w-[500px] md:w-[650px] h-[350px] md:h-[450px] bg-gradient-to-b from-slate-900 to-black rounded-[1.5rem] overflow-hidden">
                    {/* Screen Content */}
                    <div className="absolute inset-0 flex flex-col">
                      {/* Header */}
                      <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-6">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <div className="text-white font-bold text-xl">Интерактивный стол</div>
                              <div className="text-white/70 text-base">Мультитач до 40 касаний</div>
                            </div>
                          </div>
                          <div className="text-white/60 text-xl font-medium">55"</div>
                        </div>
                      </div>
                      {/* Content */}
                      <div className="flex-1 p-6 flex items-center justify-center">
                        <div className="grid grid-cols-3 gap-5 w-full">
                          {[
                            ...
                            <div key={i} className="bg-white/5 border border-white/10 rounded-xl p-5 text-center hover:bg-white/10 transition-all cursor-pointer">
              ...
              {/* Table Legs */}
              <div className="flex justify-center gap-[440px] md:gap-[580px] mt-[-10px]" style={{ transform: 'translateZ(-30px)' }}>
                <div className="w-12 h-44 bg-gradient-to-b from-zinc-800 to-zinc-900 rounded-b-lg"
              ...
              {/* Floor Shadow */}
              <div className="w-[600px] md:w-[750px] h-5 bg-gradient-to-b from-zinc-900 to-black rounded-full mt-[-10px] opacity-80"
            ...
            <div className="relative animate-fadeIn" style={{ transformStyle: 'preserve-3d' }}>
              {/* Screen */}
              <div 
                className="relative bg-gradient-to-b from-zinc-700 via-zinc-800 to-zinc-900 rounded-[2.5rem] p-3 md:p-4 mx-auto"
                style={{ 
                  boxShadow: `
                    0 0 0 1px rgba(255,255,255,0.15),
                    0 50px 100px -20px rgba(0,0,0,0.9),
              ...
              >
                <div className="bg-black rounded-[2rem] p-2 relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-transparent rounded-[2rem] pointer-events-none z-10"></div>
                  <div className="relative w-[380px] md:w-[520px] h-[260px] md:h-[380px] bg-gradient-to-b from-slate-900 to-black rounded-[1.5rem] overflow-hidden">
                    {/* Screen Content */}
                    <div className="absolute inset-0 flex flex-col">
                      {/* Header */}
                      <div className="bg-gradient-to-r from-cyan-600 to-blue-600 px-6 py-5">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="text-white font-bold text-lg">Настенная панель</div>
                            <div className="text-white/70 text-sm">Информационный дисплей 43"</div>
                          </div>
                        </div>
                      </div>
                      {/* Content */}
                      <div className="flex-1 p-5">
                        <div className="grid grid-cols-2 gap-4 h-full">
                          <div className="bg-white/5 border border-white/10 rounded-xl p-5 flex flex-col justify-center items-center hover:bg-white/10 transition-all cursor-pointer">
                            <svg className="w-12 h-12 text-cyan-400 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            </svg>
                            <span className="text-white font-medium text-lg">Навигация</span>
                          </div>
                          <div className="bg-white/5 border border-white/10 rounded-xl p-5 flex flex-col justify-center items-center hover:bg-white/10 transition-all cursor-pointer">
                            <svg className="w-12 h-12 text-cyan-400 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <span className="text-white font-medium text-lg">Информация</span>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="flex justify-center mt-4">
                <div className="w-32 h-8 bg-gradient-to-b from-zinc-700 to-zinc-800 rounded-lg"
            ...
            <div className="relative animate-fadeIn" style={{ transformStyle: 'preserve-3d' }}>
              ...
              >
                <div className="bg-black rounded-[2rem] p-2 relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-white/10 via-transparent to-transparent rounded-[2rem] pointer-events-none z-10"></div>
                  <div className="relative w-[360px] md:w-[480px] h-[260px] md:h-[340px] bg-gradient-to-b from-slate-900 to-black rounded-[1.5rem] overflow-hidden">
                    {/* Screen Content */}
                    <div className="absolute inset-0 flex flex-col">
                      {/* Header */}
                      <div className="bg-gradient-to-r from-orange-500 to-red-500 px-6 py-5">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="text-white font-bold text-lg">Настольный дисплей</div>
                            <div className="text-white/70 text-sm">Портативный 15.6"</div>
                          </div>
                        </div>
                      </div>
                      {/* Content */}
                      <div className="flex-1 p-5 flex items-center justify-center">
                        <div className="grid grid-cols-2 gap-4 w-full">
                          {['Регистрация', 'Опросы', 'Лиды', 'QR-код'].map((item, i) => (
                            <div key={i} className="bg-white/5 border border-white/10 rounded-xl p-4 text-center hover:bg-white/10 transition-all cursor-pointer">
              ...
              <div className="flex flex-col items-center mt-[-5px]" style={{ transform: 'translateZ(5px)' }}>
                <div className="w-16 h-12 bg-gradient-to-b from-zinc-800 to-zinc-900 rounded-b-lg"
                  style={{ boxShadow: 'inset 2px 0 4px rgba(0,0,0,0.3), inset -2px 0 4px rgba(0,0,0,0.3)' }}></div>
                <div className="w-56 h-8 bg-gradient-to-b from-zinc-800 to-zinc-900 rounded-xl mt-[-2px]"
                  style={{ boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.1)' }}></div>
                <div className="w-64 h-4 bg-gradient-to-b from-zinc-900 to-black rounded-lg"
